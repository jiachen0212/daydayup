...
if __name__ == '__main__':
    ...
    test_img_path = './cam_img'
    path_imgs = [os.path.join(test_img_path, a) for a in os.listdir(test_img_path)]
    path_net = "./net_params_72p.pkl" 
    output_dir = "./cam_res"
    ...
    for path_img in path_imgs:
        ...
        print("{}, predict: {}".format(img_name, classes[idx]))
